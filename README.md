...
# Long-read Nextflow Processing Pipeline

A modular Nextflow pipeline for processing long-read sequencing data (POD5/FASTQ) and generating taxonomic profiles using Kraken.
